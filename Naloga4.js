...
var board = new firmata.Board("/dev/ttyACM0", function(){
    ...
    board.pinMode(11, board.MODES.OUTPUT); // pin12 kot izhod
    console.log("Aktiviramo Pin 11");
    board.pinMode(9, board.MODES.OUTPUT); // pin11 kot izhod
});
...
board.on("ready", function() {
    ...
    board.analogRead(0, function(value){
        ...
        if(želenaVrednost >= 485 && želenaVrednost <= 539)
        {
